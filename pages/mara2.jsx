          ...
          <div className="destination-details-wrapper">
            <div className="destination-info wow fadeInUp">
              ...
              <p>
                ...
                buffalo, and rhinoceros) and other wildlife. 
                <br/>- Evening: Return to your accommodation for dinner and relaxation.
                <br />
                <br/>

                Day 2: <br/>- Morning: Early morning game drive to witness wildlife
                activity during the cool hours. You might see predators on the hunt. <br/>- Mid-morning: Return to your lodge for breakfast and some
                ...
                <p class="price">
                  ...
                  <span class="currency"> KSH</span> 14,950 per person sharing
                </p>
              ...
              <ul class="features-list mb-40">
                <li>
                  <span>
                    <i class="fas fa-badge-check"></i>Return transport in a Tour van
                  </span>
                </li>
                <li>
                  <span>
                    <i class="fas fa-badge-check"></i>2 nights accommodation
                  </span>
                </li>
                <li>
                  <span>
                ...
                <li>
                  <span>
                    <i class="fas fa-badge-check"></i> Full board Meal
                  </span>
                </li>
                <li>
                  <span>
                ...
                <li>
                  <span>
                    <i class="fas fa-badge-check"></i>Professional game drive
                  </span>
                </li>
              </ul>
              <h3>EXCLUSIONS</h3>
